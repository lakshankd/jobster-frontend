    ...
    var placements = [
        {
            ...
            body: '<p><a class="freelance" href="#">Freelance</a></p>' +
                '<div class="mt-2 job-grid-map-price"><span class="me-2"><i class="fas fa-filter pe-1"></i>Accountancy </span> <span class="ml-auto"> <i class="fas fa-map-marker-alt pe-1"> </i> Needham, MA </span></div>',
