      ...
      <div className="accordion-style" id="accordion-Two">
        <div className="card">
          <div className="card-header" id="headingOne">
            <h5 className="accordion-title mb-0">
              <button
                className="btn btn-link d-flex align-items-center ms-auto"
                data-bs-toggle="collapse"
                data-bs-target="#collapseOne"
                aria-expanded="true"
                aria-controls="collapseOne"
              >
                Is registration on the Jobster free?{" "}
          ...
          >
            <div className="card-body">
              <p>
                ...
                give you — you are the only one with the power to motivate you.
                Motivation cannot be an external force, it must come from within
                as the natural product of your desire to achieve something and
                your belief that you are capable to succeed at your goal.
              ...
              <ol className="ps-3 mb-0">
                ...
                <li>
                  his is important because nobody wants to put significant.
                </li>
        ...
        <div className="card">
          <div className="card-header" id="headingTwo">
            <h5 className="accordion-title mb-0">
              <button
                className="btn btn-link d-flex align-items-center ms-auto collapsed"
                data-bs-toggle="collapse"
                data-bs-target="#collapseTwo"
                aria-expanded="false"
                aria-controls="collapseTwo"
              >
                I'm new to Jobster. How can I register for free?{" "}
                <i className="fas fa-chevron-down fa-xs"></i>
              </button>
            </h5>
          </div>
          ...
          >
            <div className="card-body">
              <p>
                ...
                smart enough”, “I’m not lucky enough”, and the worst, We carry
                them with us like rocks in a knapsack, and then use them to
                sabotage our success. So, how twisted is that?!?!
              </p>
              <ol className="ps-3 mb-0">
        ...
        <div className="card">
          <div className="card-header" id="headingthree">
            <h5 className="accordion-title mb-0">
              ...
              >
                How does Jobster work for job seekers?{" "}
                <i className="fas fa-chevron-down fa-xs"></i>
              </button>
            </h5>
          </div>
