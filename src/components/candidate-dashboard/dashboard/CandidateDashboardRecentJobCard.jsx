...
const CandidateDashboardRecentJobCard = ({
  img,
  title,
  type,
  company,
    ...
    <div className="col-12">
      <div className="job-list border-bottom">
          ...
          <div className="job-list-info">
            ...
            <div className="job-list-option">
              <ul className="list-unstyled">
                <li>
                  {" "}
                  <span>via</span> <a href="employer-detail.html">{company}</a>{" "}
                </li>
                <li>
        ...
        <div className="job-list-favourite-time">
          {" "}
          <a className="mb-3 d-block order-2" href="#">
...
export default CandidateDashboardRecentJobCard;
