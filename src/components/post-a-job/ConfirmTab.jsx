        ...
        <div className="row">
          ...
          <div className="col-sm-12">
            ...
            <h6 className="mb-2 text-light">
              Thank you for submitting, your job has been published. if you need
              help please contact us via{" "}
            </h6>
            <h6 className="mb-0 text-light">Email support@jobster.com</h6>
          </div>
          <div className="col-12 mt-4 mt-sm-5">
            <a className="btn btn-outline-primary mb-3 mb-sm-0" href="#">
              Manage Jobs
            </a>
            <a className="btn btn-outline-primary mb-3 mb-sm-0" href="#">
              View Job
